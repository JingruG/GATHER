...
from tokenization_utils import EXTRA_TOKS
...
if __name__ == "__main__":
    glove2npy(glove_path='/data/gjr/ConceptNet/numberbatch-en-19.08.txt', output_npy_path='/data/gjr/ConceptNet/transe/nb.npy', output_vocab_path='/data/gjr/ConceptNet/transe/nb.vocab', skip_head=True)
    load_pretrained_embeddings(glove_npy_path='/data/gjr/ConceptNet/transe/nb.npy', glove_vocab_path='/data/gjr/ConceptNet/transe/nb.vocab', vocab_path='/data/gjr/ConceptNet/numberbatch-19.08-entity.txt', save_path='/data/gjr/ConceptNet/transe/concept.nb.npy')

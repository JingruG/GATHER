...
class RandomWalk:
    ...
    def __init__(self, graph, walk_length=80, num_walks=10, p=1, q=1, weight_key='weight',
                 workers=1, sampling_strategy=None, quiet=False, temp_folder=None, start_ids=[]):
        """
            ...
            for current_node in self.graph.neighbors(source):
                ...
                for destination in self.graph.neighbors(current_node):
                    ...
                    if destination == source:  # Backwards probability
                        ss_weight = self.graph[current_node][destination][0].get(
                    ...
                    # print('ss_weight', self.graph[current_node][destination], self.graph[current_node][destination].get(self.weight_key), self.graph[current_node][destination].get(self.weight_key, 1))
                ...
                # Normalize
                # print('unnormalized_weights', unnormalized_weights)
...
def parallel_generate_walks(d_graph, global_walk_length, num_walks, cpu_num, sampling_strategy=None,
                            ...
                            first_travel_key=None, quiet=False, start_ids=[]):
    """
    Generates the random walks which will be used as the skip-gram input.
    :return: List of walks. Each walk is a list of nodes.
    """
    ...
    for n_walk in range(num_walks):
        ...
        for source in start_ids:
            ...
            while len(walk) < walk_length:
                ...
                # Skip dead end nodes
                if not walk_options:
                    # print('d_graph[walk[-1]]', walk[-1], d_graph[walk[-1]])
                    break

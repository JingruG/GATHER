...
import sys
sys.path.insert(0, '/home/jingrugan/KBVQA/MAVEX/vqaEval/PythonHelperTools/vqaTools')

sys.path.insert(0, 'home/jingrugan/KBVQA/MAVEX/vqaEval/PythonEvaluationTools')
from vqa import VQA
...
def evaluate_vqa(pickle_results):
    annFile = '/data/gjr/OK-VQA/Annotations/mscoco_val2014_annotations.json'
    quesFile = '/data/gjr/OK-VQA/Questions/OpenEnded_mscoco_val2014_questions.json'
    label2ans = pickle.load(open('data/okvqa_new/cache/trainval_label2ans_729.pkl', 'rb'))
    resFile = []
    qid2gt_answer = pickle.load(
        open("//data/gjr/mavex/val_qid2answers_keep_0.pkl", 'rb'))
...
def evaluate_good_or_vqa(pickle_results):
    ...
    label2ans = pickle.load(open('data/okvqa_new/cache/trainval_label2ans_729.pkl', 'rb'))
    ques = json.load(
        open('/data/gjr/OK-VQA/Questions/OpenEnded_mscoco_val2014_questions.json'))['questions']
    qid2question = {}
    for q in ques:
